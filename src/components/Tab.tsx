...
const showTasks = () => {
  ...
  return (
    <div className={`flex ${isToday ? "bg-blue-200/50" : ""} justify-center items-center ` } onClick={showTasks }>
        <div className="border-2 border-black w-[3rem] h-[3rem] text-center flex justify-center items-center">
            {day}
        </div>
        <div className="text-center pl-[5px]">
            <p>{dayOfWeek}</p> 
